<template>
  <div class="select-none">
    <div
      class="flex min-h-screen bg-gray-100 h-full font-sans antialiased bg-white text-black"
    >
      <div class="w-64 bg-white border-r border-[#196CF4]">
        <div class="m-4">
          <a
            href="/sigma"
