      ...
      datasets: [
        {
          ...
          data: monthLabelss2.map(
            (month) =>
              prores.data.result.find((item) => item._id.month === month)
                ?.totalAmount || 0
          ),
          fill: false,
